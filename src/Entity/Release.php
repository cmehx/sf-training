...
#[ApiResource(
    operations: [
        new Get(normalizationContext: ['groups' => 'release:item:get']),
        new GetCollection(normalizationContext: ['groups' => 'release:list:get']),
        new Post(),
        new Put(),
        new Delete()
    ],
...
class Release
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['release:list:get', 'artist:item:get', 'release:item:get'])]
    private ?int $id = null;
